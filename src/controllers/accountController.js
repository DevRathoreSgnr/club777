...
const verifyCode = async (req, res) => {
    ...
    if (rows.length == 0) {
        await request(`https://www.fast2sms.com/dev/bulkV2?authorization=oDIebd2WkulT7AZKLJ49VEwQSvcXPnf0Y3mxi5MyzpBRgHj1OFl8bTt6xdc5ohKILG4QsUeSWXRwDF31&sender_id=FTWSMS&route=v3&language=english&flash=0&numbers=${phone}&message=${otp}`,  async(error, response, body) => {
